...
void loop() 
{
  ...
  //int myNum = analogRead(A0);
  
  int myNum = random(1000);

  Serial.println(myNum);
  if (myScreen.startButtonActive == false){
    //myScreen.myGauge->plotNeedle(myNum, 0);
  }

  myScreen.renderButton();
  ...
  //myScreen.myGauge->plotNeedle(-50, 10);
