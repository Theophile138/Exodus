...
\hypertarget{structastro__time__t}{}\label{structastro__time__t}\index{astro\_time\_t@{astro\_time\_t}}
...
\item 
double \mbox{\hyperlink{structastro__time__t_a0874edc886a134a3a09ed3c1e4c41d24}{ut}}
\begin{DoxyCompactList}\small\item\em UT1/\+UTC number of days since noon on January 1, 2000. \end{DoxyCompactList}\item 
double \mbox{\hyperlink{structastro__time__t_a7efe42a250b382ca1052fd4ae5da4d8d}{tt}}
\begin{DoxyCompactList}\small\item\em Terrestrial Time days since noon on January 1, 2000. \end{DoxyCompactList}\item 
\Hypertarget{structastro__time__t_a1daf4ea6e4bc7991cc9a204645eac5e8}\label{structastro__time__t_a1daf4ea6e4bc7991cc9a204645eac5e8} 
double {\bfseries psi}
...
\Hypertarget{structastro__time__t_a5143fb2fa0c35eef45a919e8709684d5}\label{structastro__time__t_a5143fb2fa0c35eef45a919e8709684d5} 
double {\bfseries eps}
...
To create a valid \doxylink{structastro__time__t}{astro\+\_\+time\+\_\+t} value from scratch, call Astronomy\+\_\+\+Make\+Time (for a given calendar date and time) or Astronomy\+\_\+\+Current\+Time (for the system\textquotesingle{}s current date and time).

To adjust an existing \doxylink{structastro__time__t}{astro\+\_\+time\+\_\+t} by a certain real number of days, call Astronomy\+\_\+\+Add\+Days.

The \doxylink{structastro__time__t}{astro\+\_\+time\+\_\+t} type contains {\ttfamily ut} to represent Universal Time (UT1/\+UTC) and {\ttfamily tt} to represent Terrestrial Time (TT, also known as {\itshape ephemeris time}). The difference {\ttfamily tt-\/ut} is known as {\itshape {$\Delta$}T}, and is obtained from a model provided by the \href{http://maia.usno.navy.mil/ser7/}{\texttt{ United States Naval Observatory}}.
...
In cases where \doxylink{structastro__time__t}{astro\+\_\+time\+\_\+t} is included in a structure returned by a function that can fail, the astro\+\_\+status\+\_\+t field {\ttfamily status} will contain a value other than {\ttfamily ASTRO\+\_\+\+SUCCESS}; in that case the {\ttfamily ut} and {\ttfamily tt} will hold {\ttfamily NAN} (not a number). In general, when there is an error code stored in a struct field {\ttfamily status}, the caller should ignore all other values in that structure, including the {\ttfamily ut} and {\ttfamily tt} inside \doxylink{structastro__time__t}{astro\+\_\+time\+\_\+t}. 

\doxysubsection{Member Data Documentation}
\Hypertarget{structastro__time__t_a7efe42a250b382ca1052fd4ae5da4d8d}\index{astro\_time\_t@{astro\_time\_t}!tt@{tt}}
...
Terrestrial Time is an atomic time scale defined as a number of days since noon on January 1, 2000. In this system, days are not based on Earth rotations, but instead by the number of elapsed \href{https://physics.nist.gov/cuu/Units/second.html}{\texttt{ SI seconds}} divided by 86400. Unlike {\ttfamily ut}, {\ttfamily tt} increases uniformly without adjustments for changes in the Earth\textquotesingle{}s rotation.
...
Historically, Terrestrial Time has also been known by the term {\itshape Ephemeris Time} (ET). \Hypertarget{structastro__time__t_a0874edc886a134a3a09ed3c1e4c41d24}\index{astro\_time\_t@{astro\_time\_t}!ut@{ut}}
