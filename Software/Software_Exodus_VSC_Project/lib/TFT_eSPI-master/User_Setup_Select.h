...
#include <User_Setups/Setup_ILI9341_ESP32.h>

/*
#include "../../CLIV2/_config.h"
#if defined(AOS_ESP32_D1R32)
  #include <User_Setups/D1_R32.h>
#elif defined(AOS_ESP32_AZTOUCH)
  #include <User_Setups/AZ_Touch.h>
#elif defined(AOS_ESP32_T_WATCH2020V1) || defined(AOS_ESP32_T_WATCH2020V2) || defined(AOS_ESP32_T_WATCH2020V3)
  #include <User_Setups/LilygoWatch.h>
#else
  #warning "eSPI Hardware not defined..."
  #include <User_Setups/D1_R32.h>
#endif
*/
